  ...
  return (
    <div className="min-h-screen bg-white w-full overflow-x-hidden py-8 sm:py-12">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 w-full">
        <Link 
          to="/"
          className="inline-block text-[#2C1F14] hover:opacity-80 transition-opacity mb-6 text-base sm:text-lg font-medium"
        >
          Назад
        </Link>
        
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2C1F14] mb-6 sm:mb-8">
          О компании
        </h1>
        ...
        {/* Миссия */}
        <div className="mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#2C1F14] mb-4 sm:mb-6">
            Наша миссия
          </h2>
        ...
        {/* Почему выбирают нас */}
        <div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#2C1F14] mb-6 sm:mb-8">
            Почему выбирают нас
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {/* Безопасная сделка */}
            <div className="bg-white border-2 border-[#2C1F14] rounded-lg p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#2C1F14] mb-3 sm:mb-4">
                Безопасная сделка
              </h3>
