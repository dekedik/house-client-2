    ...
    <div className="min-h-screen bg-white w-full overflow-x-hidden">
      <div className="w-full relative max-w-full overflow-hidden">
        ...
        <div className="hidden md:flex absolute bottom-4 sm:bottom-6 md:bottom-8 left-0 right-0 flex-col sm:flex-row gap-3 sm:gap-4 z-10" style={{ maxWidth: '1280px', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '1rem', paddingRight: '1rem' }}>
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Link
              to="/catalog"
              className="bg-white px-4 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 lg:py-3.5 rounded-full font-semibold text-xs sm:text-sm md:text-base lg:text-lg transition-all duration-200 shadow-lg text-center backdrop-blur-sm text-[#540b0e] whitespace-nowrap"
            ...
            <button
              ...
              className="bg-white px-4 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 lg:py-3.5 rounded-full font-semibold text-xs sm:text-sm md:text-base lg:text-lg transition-all duration-200 shadow-lg backdrop-blur-sm text-[#540b0e] whitespace-nowrap"
              style={{ backgroundColor: 'rgba(255, 255, 255, 1)' }}
            >
              Рассчитать проект
            </button>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white w-full overflow-x-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 w-full">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8 sm:mb-10 md:mb-12 text-[#540b0e]">
            Способы покупки
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="md:col-span-1 bg-white border-2 border-gray-200 rounded-lg p-6 sm:p-8 hover:shadow-lg transition-all cursor-pointer text-center">
              <div className="mb-4 sm:mb-6">
                <svg className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-[#540b0e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-4 sm:p-6 hover:shadow-lg transition-all cursor-pointer text-center">
                <div className="mb-3 sm:mb-4">
                  <svg className="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-[#540b0e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="md:col-span-3 bg-white border-2 border-gray-200 rounded-lg p-6 sm:p-8 hover:shadow-lg transition-all cursor-pointer">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6">
                <div className="flex-shrink-0">
                  <svg className="w-12 h-12 sm:w-16 sm:h-16 text-[#540b0e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="w-full md:w-1/2 p-4 sm:p-6 flex flex-col justify-center">
                    ...
                    <Link
                      ...
                      className="w-fit bg-[#540b0e] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-sm sm:text-base md:text-lg hover:bg-[#43090b] transition-colors duration-200 inline-block"
                    >
                      Подробнее
                    </Link>
                  </div>
          ...
          >
            ...
            {isFormSubmitted ? (
              <div className="text-center py-8 sm:py-12">
                <div className="mb-4 sm:mb-6">
                  <svg className="w-16 h-16 sm:w-20 sm:h-20 mx-auto text-[#540b0e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
